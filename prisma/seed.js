...
async function main() {
  ...
  console.log("Mijozlar (Qarzdorlar) qo'shilmoqda...");
  const customers = [
    {
      name: "Akmal aka (14-uy)",
      phone: "+998 90 123 45 67",
      address: "Bog' ko'chasi 14-uy",
      notes: "Doimiy qo'shni, oylik tushsa to'laydi",
      totalDebt: 345000,
    },
    {
      name: "Dilshod usta",
      phone: "+998 93 987 65 43",
      address: "Avtomoyka yonidagi usta",
      notes: "Hafta oxirida hisob-kitob qiladi",
      totalDebt: 185000,
    },
    {
      name: "Malika opa (O'qituvchi)",
      phone: "+998 97 555 44 33",
      address: "24-maktab yonida",
      notes: "Avans kunlari beradi",
      totalDebt: 92000,
    },
    {
      name: "Jasur (Taksist)",
      phone: "+998 94 333 22 11",
      address: "3-dom 12-kvartira",
      notes: "Kechqurun kirib to'laydi",
      totalDebt: 0,
    },
  ];
  ...
  console.log("Qarz tarixi qo'shilmoqda...");
  // Akmal aka debt history
  ...
  await prisma.debtTransaction.create({
    data: {
      ...
      type: "BORROW",
      amount: 250000,
      description: "Oziq-ovqat va go'sht mahsulotlari",
  ...
  await prisma.debtTransaction.create({
    data: {
      ...
      type: "PAYMENT",
      amount: 100000,
      description: "Qisman to'landi (Karta orqali)",
  ...
  await prisma.debtTransaction.create({
    data: {
      ...
      type: "BORROW",
      amount: 195000,
      description: "Yog', shakar, un va ichimliklar",
  ...
  await prisma.debtTransaction.create({
    data: {
      ...
      type: "BORROW",
      amount: 185000,
      description: "Coca-Cola, sigaret, qandolat",
  ...
  await prisma.debtTransaction.create({
    data: {
      ...
      type: "BORROW",
      amount: 92000,
      description: "Sut, non, tuxum, shakar",
      dueDate: new Date(Date.now() + 7 * 24 * 60 * 60 * 1000),
      createdAt: new Date(),
    },
  });

  console.log("Oldingi savdolar qo'shilmoqda...");
  // Sample sales over past 3 days
  const sampleSales = [
    {
      totalAmount: 48500,
      totalCost: 38000,
      ...
      items: [
        ...
        { barcode: "4780045612345", productId: createdProducts[8].id, quantity: 1, costPrice: 18000, sellingPrice: 23000, subtotal: 23000 },
  ...
  for (const [index, s] of sampleSales.entries()) {
  ...
  console.log("Muvaffaqiyatli yakunlandi! Do'kon ma'lumotlari yuklandi.");
}
